...
namespace eStoreWeb
{
    ...
    public partial class eStoreEntities1 : DbContext
    {
        public eStoreEntities1()
            : base("name=eStoreEntities1")
        {
        }
        ...
        public virtual DbSet<PRODUKTI_DETAJET> PRODUKTI_DETAJET { get; set; }
